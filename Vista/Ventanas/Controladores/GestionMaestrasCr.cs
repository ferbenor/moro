...
namespace WindowsApp
{
    public class GestionMaestrasCr
    {
        ...
        */
        ...
        #region FILTROS
        public bool Filtro(object unaLista, string unTexto)
        {
            return objetoDelegado.ObtenerFiltro().Invoke(unaLista, unTexto);
        }
        ...
        public void RaiseBorrarLista(object sender)
        {
            AfectarObjetosEventArgs e = new AfectarObjetosEventArgs();
            if (AntesAfectarObjetoEvent != null)
            {
            ...
            {
                objetoDelegado.ProveedorInstancia = this.ProveedorInstancia;
                e.Completado = objetoDelegado.ObtenerBorrarLista().Invoke(e.Modulo, e.ListaSeleccionados);
        ...
        private object CargaGrid(string modulo, DataGridView objetoGrid)
        {
            ...
            objetoDelegado.ProveedorInstancia = this.ProveedorInstancia;
            proveedor = objetoDelegado.ObtenerEstructuraGrid(modulo, objetoGrid);
            return proveedor;
        }
        ...
        public UserControl CargarControlUsuario(string unNombreControl)
        {
            try
            {
                ...
                unTipo = Type.GetType("WindowsApp." + unNombreControl);
                if (unTipo != null)
    ...
    public class AfectarObjetosEventArgs
    {
        ...
        private IList _listaSeleccionados;
        ...
        public IList ListaSeleccionados { get { return _listaSeleccionados; } set { _listaSeleccionados = value; } }
