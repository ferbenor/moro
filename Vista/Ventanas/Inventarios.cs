...
{
    public partial class Inventarios : Form, IAccesoMetodos
    {
        ...
        private inventario objetoLocal = new inventario();
        ...
        public Inventarios()
        {
            ...
            this._dgrFKDetallesInventario.AutoGenerateColumns = false;
        ...
        private void Ventas_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this._txtBodega1.ButtonCustom.Image = General.Imagenes.Images["Agregar.png"];
                this._txtBodega1.ButtonCustom2.Image = General.Imagenes.Images["Eliminar.ico"];
                this._txtBodega2.ButtonCustom.Image = General.Imagenes.Images["Agregar.png"];
                this._txtBodega2.ButtonCustom2.Image = General.Imagenes.Images["Eliminar.ico"];
                ...
                this._dgrFKDetallesInventario.SetColumnasGrid(this.ColumnasGrid, 1);
                //this.dgrLista.Columns.AddRange(VentanaPrincipalCr.Instancia.GeneraColumnasGrid(this.ColumnasGrid));
                //this._dgrFKDetallesInventario.Columns.AddRange(VentanaPrincipalCr.Instancia.GeneraColumnasGrid(this.ColumnasGrid, 1));
                //DATOS INICIALES Y VINCULACION DE CONTROLES
                this.bs.DataSource = InventarioPr.Instancia.ObtenerDatos();
                this.dgrLista.DataSource = this.bs;
                this._txtTipo.Text = "INGRESO";
                this._txtPeriodo.Text = General.periodoActual.ToString();

                //this._cboTipo.DisplayMember = "descripcion";
                //this._cboTipo.ValueMember = "objeto";
                //this._cboTipo.DataSource = CantonPr.Instancia.Registros();

                this._txtNumero.DataBindings.Add(new Binding("Text", this.bs, "numero", true));
                this._txtTipo.DataBindings.Add(new Binding("Text", this.bs, "tipo", true));
                this._dtpFecha.DataBindings.Add(new Binding("Value", this.bs, "fecha", true));
                this._txtBodega1.DataBindings.Add(new Binding("Text", this.bs, "fkbodegas1", true));
                this._txtObservacion.DataBindings.Add(new Binding("Text", this.bs, "observacion", true));
                this._txtBodega2.DataBindings.Add(new Binding("Text", this.bs, "fkbodegas2", true));
                this._lblAnulado.DataBindings.Add(new Binding("Visible", this.bs, "esanulado", true));
                this._dgrFKDetallesInventario.DataBindings.Add(new Binding("DataSource", this.bs, "FDetalle", true));
                //VALIDACIONES ADICIONALES
                tieneFiltro = GestionMaestrasCr.Instancia.Filtro(this.bs.DataSource, "");
                this._dgrFKDetallesInventario.PermitirEventosInternos = true;
            }
            catch (Exception ex)
            {
            ...
            {
                {
                    ...
                    try
                    {
                        InventarioPr.Instancia.Grabar(this.objetoLocal);
                        this.idRegistro = this.objetoLocal.numero;
        ...
        public void Eliminar()
        {
            if (this._txtNumero.Text != "0")
                ...
                {
                    this.objetoLocal = new inventario() { numero = (int)ValorCelda("colnumero") };
                    InventarioPr.Instancia.Borrar(this.objetoLocal);
        ...
        public void Actualizar()
        {
            try
            {
                ...
                InventarioPr.Instancia.Registros(this.expresion.Compilar(), this.expresion.parametros).CargarGrid(this.dgrLista, this.bs);

                this.bs.DataSource = InventarioPr.Instancia.ObtenerDatos(this.expresion.Compilar(), this.expresion.parametros);
        ...
        void _dgrFKDetallesVenta_AntesBuscarCell(AntesBuscarCellEventArgs e)
        {
            ...
            {
                e.TipoConsulta = TipoConsulta.Productos;
            }
            else
                e.Cancel = true;
        }
        ...
        {
            //GestionMaestrasCr.Instancia.ControlEdicionGrid(this._dgrFKDetallesInventario);
        }
        ...
        private void _txtBodega1_ButtonCustomClick(object sender, EventArgs e)
        {
            BodegaPr.Instancia.BuscarBodega(this.bs.Current, 1);
            this.bs.ResetBindings(false);
        }

        private void _txtBodega2_ButtonCustomClick(object sender, EventArgs e)
        {
            BodegaPr.Instancia.BuscarBodega(this.bs.Current, 2);
            this.bs.ResetBindings(false);
        }
    }
}