...
{
    public class GeneroPr
    {
        #region VARIABLES
        private static GeneroPr instancia = null;
        #endregion VARIABLES

        #region PROPIEDADES
        public static GeneroPr Instancia { get { if (instancia == null) instancia = new GeneroPr(); return instancia; } set { instancia = value; } }
        ...
        public genero RegistroPorId(int unId)
        {
        ...
        public int Grabar(IEnumerable<genero> items)
        {
        ...
        public void ArmarGrid(DataGridView objetoGrid, string expresion = null, params object[] parametros)
        {
            ...
            //objetoGrid.DataSource = SoporteList<genero>.ToBindingList(this.Registros("order by id"));
        }
