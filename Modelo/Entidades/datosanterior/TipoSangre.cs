...
namespace Entidades
{
    public class TipoSangre : Instrumental
    {
        #region VARIABLES
        private short id;
        private string descripcion;
        private const string nombreTabla = "tipossangre";
        #endregion VARIABLES

        #region PROPIEDADES
        public short Id { get { return this.id; } }
        public string Descripcion { get { return this.descripcion; } set { this.descripcion = value; } }
        public TipoSangre Objeto { get { return this; } }
        #endregion PROPIEDADES

        #region CONSTRUCTORES
        public TipoSangre() { }

        public TipoSangre(short Id) { this.id = Id; }
        ...
        protected override List<CamposTabla> GetCampos(List<CamposTabla> lc)
        {
            ...
            lc.Add(new CamposTabla("descripcion", false, System.Data.DbType.String, 5, this.descripcion));
            return lc;
        }
        ...
        {
            if (obj is TipoSangre)
            {
                TipoSangre oVar = obj as TipoSangre;
