...
namespace Entidades
{
    public class EstadoPersona : Instrumental
    {
        #region VARIABLES
        private short id;
        private string descripcion;
        private string abreviatura;
        private const string nombreTabla = "estadospersonas";
        #endregion VARIABLES
        ...
        public EstadoPersona(short Id) { this.id = Id; }
        ...
        {
            if (obj is EstadoPersona)
            {
                EstadoPersona oVar = obj as EstadoPersona;
