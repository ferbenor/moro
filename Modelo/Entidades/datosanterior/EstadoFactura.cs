...
namespace Entidades
{
    public class EstadoFactura : Instrumental
    {
        #region VARIABLES
        private short id;
        private string descripcion;
        private bool activo;
        private const string nombreTabla = "estadosfacturas";
        #endregion VARIABLES
        ...
        public EstadoFactura Objeto { get { return this; } }
        #endregion PROPIEDADES

        #region CONSTRUCTORES
        public EstadoFactura() { }

        public EstadoFactura(short Id) { this.id = Id; }
        ...
        {
            if (obj is EstadoFactura)
            {
                EstadoFactura oVar = obj as EstadoFactura;
