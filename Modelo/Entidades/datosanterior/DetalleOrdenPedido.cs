...
namespace Entidades
{
    public class DetalleOrdenPedido : Instrumental
    {
        #region VARIABLES
        private OrdenPedido cabeceraOrdenPedido;
        private Producto producto;
        private short cantidad;
        private decimal precio;
        private decimal total;
        public const string nombreTabla = "detalleordenespedido";
        #endregion VARIABLES

        #region PROPIEDADES
        public OrdenPedido CabeceraOrdenPedido { get { return this.cabeceraOrdenPedido; } set { this.cabeceraOrdenPedido = value; } }
        ...
        public Producto Producto
        {
            ...
            set
            {
                this.producto = value; if (value == null) { this.IdProducto = 0; this.Precio = 0; } else { this.IdProducto = value.Id; this.Precio = value.Precio1; }
            }
        }
        ...
        {
            if (obj is DetalleOrdenPedido)
            {
                DetalleOrdenPedido oVar = obj as DetalleOrdenPedido;
