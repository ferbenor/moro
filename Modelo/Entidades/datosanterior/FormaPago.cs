...
namespace Entidades
{
    public class FormaPago : Instrumental
    {
        #region VARIABLES
        private short id;
        private string descripcion;
        private const string nombreTabla = "formaspago";
        #endregion VARIABLES
        ...
        protected override List<CamposTabla> GetCampos(List<CamposTabla> lc)
        {
            ...
            lc.Add(new CamposTabla("descripcion", false, System.Data.DbType.String, 30, this.Descripcion));
        ...
        public override int CompareTo(object obj)
        {
            if (obj is FormaPago)
            {
                FormaPago oVar = obj as FormaPago;
