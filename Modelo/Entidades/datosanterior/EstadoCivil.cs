...
namespace Entidades
{
    public class EstadoCivil : Instrumental
    {
        #region VARIABLES
        private short id;
        private string nombre;
        private const string nombreTabla = "estadosciviles";
        #endregion VARIABLES
        ...
        public EstadoCivil(short Id) { this.id = Id; }
        ...
        public override int CompareTo(object obj)
        {
            ...
            {
                EstadoCivil oVar = obj as EstadoCivil;
