...
namespace Entidades
{
    public class Venta : Instrumental
    {
        #region VARIABLES
        private int id;
        ...
        private const string nombreTabla = "ventas";
        #endregion VARIABLES
        ...
        public short IdEstadoFactura { get; set; }
        public EstadoFactura EstadoFactura
        {
            get
            {
                if (this.estadoFactura == null)
                { this.estadoFactura = General.estadoFacturaCero; this.IdEstadoFactura = General.estadoFacturaCero.Id; }
                return this.estadoFactura;
            }
            set { this.estadoFactura = value; if (value == null) this.IdEstadoFactura = 0; else this.IdEstadoFactura = value.Id; }
        }
        ...
        public List<DetalleVenta> DetalleVenta { get { if (detalleVenta == null) { this.detalleVenta = new List<DetalleVenta>(); return this.detalleVenta; } else return this.detalleVenta; } set { this.detalleVenta = value; this.total = value.Sum(x => x.Total); this.saldo = decimal.Round(total - cancelado, 2); } }
        ...
        public Venta(int Id, decimal Cancelado)
        {
            this.id = Id;
        ...
        protected override List<CamposTabla> GetCampos(List<CamposTabla> lc)
        {
            ...
            lc.Add(new CamposTabla("idestadofactura", false, System.Data.DbType.Int16, 0, this.IdEstadoFactura));
